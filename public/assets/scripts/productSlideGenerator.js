...
export default async function geberateSlide() {
    ...
    products.forEach(product => {
        ...
        if(product.listPrice) template.querySelector(".last-price").textContent = `de $${product.listPrice}`;
        template.querySelector(".actual-price").textContent = `por $${product.price}`;
